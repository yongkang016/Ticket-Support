...
class KTBootstrap
{
    ...
    {
        setModeSwitch(config('theme-settings.KT_THEME_MODE_SWITCH_ENABLED'));
        setModeDefault(config('theme-settings.KT_THEME_MODE_DEFAULT'));
    }
    ...
    {
        setDirection(config('theme-settings.KT_THEME_DIRECTION'));
