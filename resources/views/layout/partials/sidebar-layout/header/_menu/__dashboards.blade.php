	...
	<div class="row">
		...
		<div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
			...
			<div class="row">
				...
				<div class="col-lg-6 mb-3">
					...
					<div class="menu-item p-0 m-0">
						<!--begin:Menu link-->
						<a href="{{ route(WebRouteName::PORTAL_API_DASHBOARD) }}" class="menu-link active">
				...
				<div class="col-lg-6 mb-3">
					...
					<div class="menu-item p-0 m-0">
						<!--begin:Menu link-->
						<a href="{{ route(WebRouteName::PORTAL_API_DASHBOARD) }}" class="menu-link">
			...
			<div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
				...
				<a href="{{ route(WebRouteName::PORTAL_API_DASHBOARD) }}" class="btn btn-sm btn-primary fw-bold">Explore</a>
			</div>
			<!--end:Landing-->
		</div>
		<!--end:Col-->
		...
		<div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
			...
			<div class="menu-item p-0 m-0">
				<!--begin:Menu link-->
				<a href="{{ route(WebRouteName::PORTAL_API_DASHBOARD) }}" class="menu-link py-2">
