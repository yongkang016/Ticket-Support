	...
	<div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
		...
		<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item here show menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
			...
			<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0 w-100 w-lg-850px">
				@include(config('theme-settings.KT_THEME_LAYOUT_DIR').'/partials/sidebar-layout/header/_menu/__dashboards')
			</div>
			<!--end:Menu sub-->
		</div>
		<!--end:Menu item-->
		...
		<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2">
			...
			<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0">
				@include(config('theme-settings.KT_THEME_LAYOUT_DIR').'/partials/sidebar-layout/header/_menu/__pages')
			</div>
			<!--end:Menu sub-->
		</div>
		<!--end:Menu item-->
		...
		<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion me-0 me-lg-2">
			...
			<!--begin:Menu sub-->
			<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0 w-100 w-lg-850px">
				@include(config('theme-settings.KT_THEME_LAYOUT_DIR').'/partials/sidebar-layout/header/_menu/__layouts')
			</div>
			<!--end:Menu sub-->
		</div>
		<!--end:Menu item-->
