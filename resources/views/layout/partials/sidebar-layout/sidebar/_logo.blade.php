...
//$logo = CouncilHelper::getLogo();
?>
<!--begin::Logo-->
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	<!--begin::Logo image-->
	<a href="{{ route(WebRouteName::WEB_ROUTE_DASHBOARD) }}">
		<img alt="Logo" src="{{ asset('storage/support-ticket.png') }}" class="h-50px w-100 app-sidebar-logo-default" />
		<img alt="Logo" src="{{ asset('storage/support-ticket.png') }}" class="h-30px w-100 app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
